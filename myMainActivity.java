package edu.cuny.qc.cs.myweatherapp;
...
public class myMainActivity extends Activity implements OnClickListener, OnItemSelectedListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        TestFairy.begin(this, "SDK-Svljwe4U");
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(myMainActivity.this,
    ...
    public void onClick(View v) {
        ...
        if (v == submit_getWeatherInfo) {
            ...
            if (urlString.equals("https://weather.com/weather/today/l/")) {
                // do something .... searchString = searchString.trim().replaceAll("\\s+", " ").replace(" ", "+");
